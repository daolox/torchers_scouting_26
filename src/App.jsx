  ...
  return (
    <div>
      ...
      {sel && (<>
        ...
        <div className="srow">
          <button className="btn-save" onClick={save} disabled={status==="saving"}>{status==="saving"?"KAYDEDİLİYOR…":existingId?"GÜNCELLE":"KAYDET"}</button>
...
function Rankings({ api, refreshKey }) {
  ...
  const pitRanked = data.map(r=>{
    ...
    return {...r,...t,score:totalPitScore(r)};
